    ...
    <div v-else>
      <div id="content" style="display: flex; flex-direction: column; flex: 1">
        ...
        <span
          ...
          <code>hc scaffold collection</code> and
          <code>hc scaffold link-type</code> and add them here as
          appropriate.</span
        >
        ...
        <span
          ...
          want to add an element here to create and list your todo items, with
          the generated <code>ui/src/todos/todos/AllTodos.vue</code> and
          <code>ui/src/todos/todos/CreateTodo.vue</code> elements.</span
        >
...
import CreateTodo from './todos/todos/CreateTodo.vue';
          ...
          <li>
            Add it into the subcomponents for the `App` component:
            <pre>
export default defineComponent({
  ...
  ...
          ...
          <li>
            Replace this "EDIT ME!" section with
            <code
...
export default defineComponent({
  ...
  async mounted() {
    ...
    this.client = await AppAgentWebsocket.connect("", "paradigm-app");
